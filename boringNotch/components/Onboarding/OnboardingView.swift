        ...
        ZStack {
            ...
            case .cameraPermission:
                PermissionRequestView(
                    ...
                    description: "Dino includes a mirror feature that lets you quickly check your appearance using your camera, right from the notch. Camera access is required only to show this live preview. You can turn the mirror feature on or off at any time in the app.",
            ...
            case .calendarPermission:
                PermissionRequestView(
                    ...
                    description: "Dino can show all your upcoming events in one place. Access to your calendar is needed to display your schedule.",
                ...
                case .remindersPermission:
                    PermissionRequestView(
                        ...
                        description: "Dino can show your scheduled reminders alongside your calendar events. Access to Reminders is needed to display your reminders.",
            ...
            case .accessibilityPermission:
                PermissionRequestView(
                    ...
                    description: "Accessibility access is required to replace system notifications with the Dino HUD. This allows the app to intercept media and brightness events to display custom HUD overlays.",
